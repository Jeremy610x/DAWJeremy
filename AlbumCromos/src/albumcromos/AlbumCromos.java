...
public class AlbumCromos {
    ...
    private void anyadirOpcionesMenu(Menu cromos_menu) {
        ...
        cromos_menu.AddOption(new OptionItem("Mostrar cromos repes "));
    }
    ...
    private void anyadirCromos(CromoDAO album) {
        try {
            ...
            album.afegirCromo(new Cromo(15,"Piccolo"));
    ...
    private void mostrarCromosRepes(CromoDAO album) {
      List<Cromo> repes = album.getRepes();
      for (Cromo cromo_repes : repes ) {
            System.out.println(cromo_repes); //toString implementado
        }
