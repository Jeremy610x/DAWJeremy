 ...
 * @author mabardaji
 */
public class FicheroLecturaCaracteres1 {
     ...
     */
    public FicheroLecturaCaracteres1(String ruta_fichero) throws FileNotFoundException {
        fichero = new File(ruta_fichero);
        fr = new FileReader(fichero);
        br = new BufferedReader(fr);
    }

    public FicheroLecturaCaracteres1() {
    }
